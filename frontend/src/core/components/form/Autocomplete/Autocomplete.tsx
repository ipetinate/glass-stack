    ...
    <div className={cn('relative space-y-2', fullWidth ? 'w-full' : 'w-fit', containerClassName)}>
      ...
      >
        ...
        <BaseAutocomplete.Portal>
          <BaseAutocomplete.Positioner sideOffset={2} className="z-50">
            <BaseAutocomplete.Popup className="max-h-64 min-w-[var(--anchor-width)] overflow-auto rounded-xl border border-white/55 bg-white/35 p-2 shadow-xl backdrop-blur-xl backdrop-saturate-150 dark:border-white/10 dark:bg-black/35">
